This app was made by:
  Pariskrit Acharya and Saurav Khatri
in the occasion of Viveka Codecamp,2024.
...
Guide on how to use the app:
  ...
  6. magnifing glass shows all your saved password. There you can insert your own password. You can generate QR code but for that you must enter Name and Password.
  7. All the password is sorted alphabatic wise. You can search your desired password by writing its exact name or password.
  8. to delete password you need to type number of the password and click in dustbin
  9. You can go to password strength checker from button at the top of the screen (has exam board and pencil symbol).
  10. To use password strength checker you write your password and click "enter". --> blank box: weak password ; half filled box: mid password ; full filled green box: strong password.
  11. you can go back to generator from the top of the screen with generator icon.
  12. to change app password click on home button.
  13. You have 7 tries to open this app else the app closes.
